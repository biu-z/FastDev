package com.biu.common.mybatis.util;
...
public class SqlMapper {
    ...
    public Map<String, Object> selectOne(String sql, Object value) {
        List<Map> list = selectList(sql, value);
        return getOne(list);
    }
    ...
    public <T> T selectOne(String sql, Object value, Class<T> resultType) {
        List<T> list = selectList(sql, resultType, value);
        return getOne(list);
    }
     ...
     * @return
     */
    public <T> List<T> selectList(String sql, Object value) {
     ...
     * @return
     */
    public <T> List<T> selectList(String sql, Class<T> resultType, Object value) {
        String msId;
        Class<?> parameterType = value != null ? value.getClass() : null;
        if (resultType == null) {
    ...
    public <T> List<T> selectList(String sql,Class<T> resultType, Object value, int pageNum, int pageSize){
        String msId;
        Class<?> parameterType = value != null ? value.getClass() : null;
        if (resultType == null) {
            msId = msUtils.selectDynamic(sql, parameterType);
        ...
        return sqlSession.selectList(msId, value,new RowBounds(pageNum,pageSize));
    }
