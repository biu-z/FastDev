...
import com.biu.core.toolbox.support.IMultiOutputStream;
import com.biu.core.toolbox.support.ImagePosition;
...
public final class ImageKit {
	 ...
	 */
	private static Logger LOGGER = LoggerFactory.getLogger(ImageKit.class);
