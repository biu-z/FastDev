...
import com.biu.core.exception.ToolBoxException;
import com.biu.core.toolbox.support.FastByteArrayOutputStream;
...
public class ZipKit {
	...
	private static Logger log = LoggerFactory.getLogger(ZipKit.class);
